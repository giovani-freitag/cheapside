...
Posição 7 da carteira, a 3.90× EV/EBIT.

## O que a tela calculou

| | R$ |
| --- | ---: |
| Valor de mercado | 8.032.050.797 |
| Dívida bruta | 6.272.048.000 |
| Caixa e equivalentes | 2.386.339.000 |
| Aplicações financeiras | 1.905.239.000 |
| **Dívida líquida** | **1.980.470.000** |
| **Valor da firma** | **10.012.520.797** |
| **EBIT (12 meses)** | **2.566.211.000** |

- EV/EBIT: **3.90×** · earnings yield 25.6%
- Dívida líquida / EBIT: 0.77×
- EBIT acumulado até 2026-06-30
- Balanço de 2026-06-30
- CNPJ 08.294.224/0001-65 · classes listadas: JHSF3
...
1. **O EBIT se repete?** O valor de 2.566.211.000 vem de operação recorrente, ou está
...
Crie `src/data/verdicts/JHSF3.json` com exatamente esta forma:
