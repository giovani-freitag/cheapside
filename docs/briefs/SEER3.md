...
Posição 15 da carteira, a 4.46× EV/EBIT.

## O que a tela calculou

| | R$ |
| --- | ---: |
| Valor de mercado | 1.785.367.989 |
| Dívida bruta | 671.041.000 |
| Caixa e equivalentes | 269.034.000 |
| Aplicações financeiras | 0 |
| **Dívida líquida** | **402.007.000** |
| **Valor da firma** | **2.187.374.989** |
| **EBIT (12 meses)** | **490.445.000** |

- EV/EBIT: **4.46×** · earnings yield 22.4%
- Dívida líquida / EBIT: 0.82×
- EBIT acumulado até 2026-06-30
- Balanço de 2026-06-30
- CNPJ 04.986.320/0001-13 · classes listadas: SEER3
...
1. **O EBIT se repete?** O valor de 490.445.000 vem de operação recorrente, ou está
...
Crie `src/data/verdicts/SEER3.json` com exatamente esta forma:
