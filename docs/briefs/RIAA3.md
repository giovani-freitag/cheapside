...
Posição 2 da carteira, a 2.04× EV/EBIT.

## O que a tela calculou

| | R$ |
| --- | ---: |
| Valor de mercado | 3.539.544.378 |
| Dívida bruta | 2.432.173.000 |
| Caixa e equivalentes | 918.437.000 |
| Aplicações financeiras | 218.014.000 |
| **Dívida líquida** | **1.295.722.000** |
| **Valor da firma** | **4.835.266.378** |
| **EBIT (12 meses)** | **2.374.389.000** |

- EV/EBIT: **2.04×** · earnings yield 49.1%
- Dívida líquida / EBIT: 0.55×
- EBIT acumulado até 2026-06-30
- Balanço de 2026-06-30
- CNPJ 08.402.943/0001-52 · classes listadas: RIAA3
...
1. **O EBIT se repete?** O valor de 2.374.389.000 vem de operação recorrente, ou está
...
Crie `src/data/verdicts/RIAA3.json` com exatamente esta forma:
