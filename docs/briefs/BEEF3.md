...
Posição 17 da carteira, a 4.72× EV/EBIT.

## O que a tela calculou

| | R$ |
| --- | ---: |
| Valor de mercado | 4.004.863.328 |
| Dívida bruta | 29.297.526.000 |
| Caixa e equivalentes | 12.260.644.000 |
| Aplicações financeiras | 2.674.304.000 |
| **Dívida líquida** | **14.362.578.000** |
| **Valor da firma** | **18.367.441.328** |
| **EBIT (12 meses)** | **3.889.523.000** |

- EV/EBIT: **4.72×** · earnings yield 21.2%
- Dívida líquida / EBIT: 3.69×
- EBIT acumulado até 2026-06-30
- Balanço de 2026-06-30
- CNPJ 67.620.377/0001-14 · classes listadas: BEEF3
...
1. **O EBIT se repete?** O valor de 3.889.523.000 vem de operação recorrente, ou está
...
Crie `src/data/verdicts/BEEF3.json` com exatamente esta forma:
