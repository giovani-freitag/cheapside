...
Posição 3 da carteira, a 2.22× EV/EBIT.

## O que a tela calculou

| | R$ |
| --- | ---: |
| Valor de mercado | 1.258.470.335 |
| Dívida bruta | 368.086.000 |
| Caixa e equivalentes | 11.547.000 |
| Aplicações financeiras | 374.528.000 |
| **Dívida líquida** | **-17.989.000** |
| **Valor da firma** | **1.240.481.335** |
| **EBIT (12 meses)** | **558.905.000** |

- EV/EBIT: **2.22×** · earnings yield 45.1%
- Dívida líquida / EBIT: -0.03×
- EBIT acumulado até 2026-06-30
- Balanço de 2026-06-30
- CNPJ 42.278.473/0001-03 · classes listadas: WIZC3
...
1. **O EBIT se repete?** O valor de 558.905.000 vem de operação recorrente, ou está
...
Crie `src/data/verdicts/WIZC3.json` com exatamente esta forma:
