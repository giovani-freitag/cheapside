...
Posição 8 da carteira, a 3.93× EV/EBIT.

## O que a tela calculou

| | R$ |
| --- | ---: |
| Valor de mercado | 3.926.074.319 |
| Dívida bruta | 4.946.057.000 |
| Caixa e equivalentes | 904.972.000 |
| Aplicações financeiras | 857.246.000 |
| **Dívida líquida** | **3.183.839.000** |
| **Valor da firma** | **7.109.913.319** |
| **EBIT (12 meses)** | **1.808.322.000** |

- EV/EBIT: **3.93×** · earnings yield 25.4%
- Dívida líquida / EBIT: 1.76×
- EBIT acumulado até 2026-06-30
- Balanço de 2026-06-30
- CNPJ 47.960.950/0001-21 · classes listadas: MGLU3
...
1. **O EBIT se repete?** O valor de 1.808.322.000 vem de operação recorrente, ou está
...
Crie `src/data/verdicts/MGLU3.json` com exatamente esta forma:
