...
Posição 13 da carteira, a 4.42× EV/EBIT.

## O que a tela calculou

| | R$ |
| --- | ---: |
| Valor de mercado | 2.736.561.013 |
| Dívida bruta | 1.581.399.000 |
| Caixa e equivalentes | 110.437.000 |
| Aplicações financeiras | 740.000 |
| **Dívida líquida** | **1.470.222.000** |
| **Valor da firma** | **4.206.783.013** |
| **EBIT (12 meses)** | **952.602.000** |

- EV/EBIT: **4.42×** · earnings yield 22.6%
- Dívida líquida / EBIT: 1.54×
- EBIT acumulado até 2026-06-30
- Balanço de 2026-06-30
- CNPJ 06.626.253/0001-51 · classes listadas: PGMN3
...
1. **O EBIT se repete?** O valor de 952.602.000 vem de operação recorrente, ou está
...
Crie `src/data/verdicts/PGMN3.json` com exatamente esta forma:
