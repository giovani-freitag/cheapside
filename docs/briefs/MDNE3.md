...
Posição 20 da carteira, a 5.01× EV/EBIT.

## O que a tela calculou

| | R$ |
| --- | ---: |
| Valor de mercado | 2.567.072.774 |
| Dívida bruta | 1.086.968.000 |
| Caixa e equivalentes | 548.320.000 |
| Aplicações financeiras | 335.380.000 |
| **Dívida líquida** | **203.268.000** |
| **Valor da firma** | **2.770.340.774** |
| **EBIT (12 meses)** | **552.726.000** |

- EV/EBIT: **5.01×** · earnings yield 20.0%
- Dívida líquida / EBIT: 0.37×
- EBIT acumulado até 2026-06-30
- Balanço de 2026-06-30
- CNPJ 12.049.631/0001-84 · classes listadas: MDNE3
...
1. **O EBIT se repete?** O valor de 552.726.000 vem de operação recorrente, ou está
...
Crie `src/data/verdicts/MDNE3.json` com exatamente esta forma:
